import { PortalCard, PortalMetric } from "../../../../packages/portal/src";
  ...
  return (
    <div className="mission-control">
      ...
      <section className="mission-control__grid">
        ...
        >
          <p>
            Portal Foundation is now hosting the Engineering Portal through a
            reusable runtime, module registry, shell, workspace, and status bar.
          </p>
        </PortalCard>
        ...
        >
          <p>
            Continue converting application UI into shared Portal primitives so
            future apps inherit the same professional interface.
          </p>
        </PortalCard>
      </section>
    </div>
